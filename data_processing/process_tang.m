...
base_path = base_path(1:end-12); % get rid of the filename itself
base_nev_path = fullfile(base_path, '..', 'data', 'tang', 'batch', 'raw');
base_cdt_path = fullfile(base_path, '..', 'data', 'tang', 'batch', 'cdts');
base_array_path = fullfile(base_path, '..', 'data', 'tang', 'batch', 'arrays');
