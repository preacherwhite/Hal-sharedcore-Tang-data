...
base_path = base_path(1:end-14); % get rid of the filename itself
base_nev_path = fullfile(base_path, '..', 'data', 'google-imagenet', 'batch', 'raw');
base_cdt_path = fullfile(base_path, '..', 'data', 'google-imagenet', 'batch', 'cdts');
base_array_path = fullfile(base_path, '..', 'data', 'google-imagenet', 'batch', 'arrays');
