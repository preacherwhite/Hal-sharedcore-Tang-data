%%% convert the Tang NEV files to CDTTables
...
base_path = base_path(1:end-15); % get rid of the filename itself
base_nev_path = fullfile(base_path, '..', 'data', 'tang', 'smith-auto', 'raw');
base_cdt_path = fullfile(base_path, '..', 'data', 'tang', 'smith-auto', 'cdts');
base_array_path = fullfile(base_path, '..', 'data', 'tang', 'smith-auto', 'arrays');
